...
let authTokens =   localStorage.getItem('user') ?  localStorage.getItem('user') : undefined
let refreshToken = localStorage.getItem('refresh') ? localStorage.getItem('refresh') : undefined 
